...
import { QrCodeEventType, CreateQrCodePayload } from "@/types/types";
...
const CreateQrModal: React.FC<CreateQrModalProps> = ({ open, onClose, onSuccess, onRefresh }) => {
    ...
    >
      ...
      >
        {({ values, errors, touched, handleChange, handleBlur, setFieldValue }) => {
          ...
          const handleEventTypeChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
            handleChange(e);
